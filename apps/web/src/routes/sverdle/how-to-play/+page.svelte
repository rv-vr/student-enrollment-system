...
<div class="text-column">
  ...
  <p>
    Sverdle is a clone of <a
      href="https://www.nytimes.com/games/wordle/index.html">Wordle</a
    >, the word guessing game. To play, enter a five-letter English word. For
    example:
  </p>
  ...
  <p>
    ...
    browser, making it impossible to cheat. It uses <code>&lt;form&gt;</code> and
