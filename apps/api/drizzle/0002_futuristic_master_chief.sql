...
--> statement-breakpoint
INSERT INTO `__new_enrollments`("id", "status", "course_id", "section_id", "user_id", "date_enrolled", "date_requested", "grade", "remark") SELECT "id", "status", "course_id", "section_id", "user_id", "date_enrolled", "date_requested", "grade", "remark" FROM `enrollments`;--> statement-breakpoint
